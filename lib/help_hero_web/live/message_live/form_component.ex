defmodule HelpHeroWeb.MessageLive.FormComponent do
  ...
  def update(%{message: message} = assigns, socket) do
    {:ok,
     ...
     |> assign(assigns)
     |> assign_new(:form, fn ->
       to_form(Conversations.change_message(message))
     end)}
  end

  @impl true
  def handle_event("validate", %{"message" => message_params}, socket) do
    changeset = Conversations.change_message(socket.assigns.message, message_params)
