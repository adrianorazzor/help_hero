defmodule HelpHeroWeb.CompanyLive.Index do
  use HelpHeroWeb, :live_view

  alias HelpHero.Companies
  alias HelpHero.Companies.Company
  ...
  @impl true
  def handle_info({HelpHeroWeb.CompanyLive.FormComponent, {:saved, company}}, socket) do
